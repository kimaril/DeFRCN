...
MAIN_ALL_CATEGORIES = {
#     1: ["passport", "driver license", "photo", "small photo", "logo", "passport cover"],
    1: [ "logo", "passport", "driver_license", "passport_cover"],
    2: ["passport", "driver_license", "logo", "passport_cover"],
    3: ["passport", "driver license", "logo", "passport cover"],
}
...
def _get_main_fewshot_instances_meta():
    ret = {
        "thing_classes": MAIN_ALL_CATEGORIES,
        "novel_classes": MAIN_ALL_CATEGORIES,
        "base_classes": MAIN_ALL_CATEGORIES,
    }
    return ret
...
def _get_builtin_metadata(dataset_name):
    ...
    elif dataset_name == "main_fewshot":
        return _get_main_fewshot_instances_meta()
